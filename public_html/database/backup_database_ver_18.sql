...
--
-- Host: localhost
-- Generation Time: Jul 02, 2019 at 04:26 PM
...
--
CREATE DATABASE IF NOT EXISTS `peternakan_app` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `peternakan_app`;
...
-- Procedures
--
DROP PROCEDURE IF EXISTS `pd_insert_detail_penggunaan_gudang`$$
...
DROP PROCEDURE IF EXISTS `pd_insert_detail_penjualan_ayam`$$
...
DROP PROCEDURE IF EXISTS `pd_select_detail_pembelian_ayam`$$
...
DROP PROCEDURE IF EXISTS `pd_show_jadwal_penggunaan`$$
...
-- Functions
--
DROP FUNCTION IF EXISTS `function_detail_type_supplier`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_kandang_persediaan`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_kerugian_ayam`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_pembelian_ayam`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_pembelian_gudang`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_pengeluaran_gudang`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_penjualan_ayam`$$
...
DROP FUNCTION IF EXISTS `function_id_detail_persediaan`$$
...
DROP FUNCTION IF EXISTS `function_id_gudang`$$
...
DROP FUNCTION IF EXISTS `function_id_jadwal_kandang`$$
...
DROP FUNCTION IF EXISTS `function_id_kandang`$$
...
DROP FUNCTION IF EXISTS `function_id_karyawan`$$
...
DROP FUNCTION IF EXISTS `function_id_supplier`$$
...
DROP FUNCTION IF EXISTS `function_id_type_gudang`$$
...
DROP FUNCTION IF EXISTS `function_status_pemberian_pakan`$$
...
DROP FUNCTION IF EXISTS `function_status_pemberian_pakan_edit`$$
...
DROP FUNCTION IF EXISTS `function_status_penjualan_ayam`$$
...
DROP TABLE IF EXISTS `detail_kandang_persediaan`;
...
DROP TABLE IF EXISTS `detail_supplier_jenis`;
...
DROP TABLE IF EXISTS `detail_type_supplier`;
...
DROP TABLE IF EXISTS `kandang_persediaan_history`;
...
DROP TABLE IF EXISTS `tb_detail_kerugian_ayam`;
...
DROP TABLE IF EXISTS `tb_detail_pembelian_ayam`;
...
DROP TABLE IF EXISTS `tb_detail_pembelian_gudang`;
...
DROP TABLE IF EXISTS `tb_detail_penggunaan_gudang`;
...
('JK_0007', '2019-07-02 05:00:00', 'KD_0001', 'TG_0001', NULL, NULL, 10, '', 'KR_0001', NULL, '2019-07-02 16:14:03', NULL),
...
('KG_0011', '2019-01-06 16:02:38', 'KD_0002', 'TG_0001', NULL, 5, 10, '', NULL, NULL, '2019-05-28 05:17:39', NULL),
('KG_0012', '2019-01-29 00:00:00', 'KD_0001', 'TG_0001', NULL, 5, 678, 'asdf', NULL, 5, '2019-05-28 05:17:31', NULL),
('KG_0013', '2019-06-03 12:00:00', 'KD_0001', 'TG_0001', NULL, NULL, 11, '', 'KR_0001', NULL, '2019-06-03 23:49:28', NULL),
('KG_0014', '2019-06-03 15:55:43', 'KD_0001', 'TG_0001', NULL, NULL, 1, '', 'KR_0001', NULL, '2019-06-13 23:36:47', NULL),
('KG_0015', '2019-06-14 18:18:30', 'KD_0002', 'TG_0001', 'KR_0001', NULL, 11, '', NULL, NULL, '2019-06-14 13:25:48', NULL);
...
DROP TABLE IF EXISTS `tb_detail_penjualan_ayam`;
...
('KA_0001', 'MA_0017', 'KD_0002', 'KR_0002', NULL, '2018-11-12 00:00:00', 48, 0, 'asdf', NULL, 5, '2019-06-18 14:02:26', '2019-01-01 14:58:18'),
('KA_0002', 'MA_0017', 'KD_0002', 'KR_0002', NULL, '2018-12-12 00:00:00', 50, 0, 'asdf', NULL, NULL, '2019-06-18 14:01:48', '2019-05-27 16:26:43'),
('KA_0004', 'MA_0017', 'KD_0001', NULL, 5, '2019-01-30 00:00:00', 2, 0, 'gfjdgngmfgm', NULL, NULL, '2019-01-29 21:11:24', '2019-05-27 16:26:43'),
('KA_0006', 'MA_0019', 'KD_0001', 'KR_0001', NULL, '2019-06-05 00:00:00', 11, 0, 'jual', NULL, NULL, '2019-06-05 23:31:22', '0000-00-00 00:00:00'),
...
DROP TABLE IF EXISTS `tb_detail_supplier_jenis`;
...
DROP TABLE IF EXISTS `tb_detail_type_supplier`;
...
DROP TABLE IF EXISTS `tb_jadwal_kandang`;
...
('JK_0001', 'KD_0002', 0, '00:10:00', '14:55:00', 'TG_0001', 'dfgsdfg', '2019-01-02 16:58:08', '2019-01-02 18:23:41'),
('JK_0002', 'KD_0001', 1, '14:15:00', '15:00:00', 'TG_0001', 'khbouyg8gy', '2019-01-03 18:27:39', '2019-01-29 21:07:19'),
('JK_0003', 'KD_0001', 1, '15:00:00', '17:00:00', 'TG_0001', 'ruyryurur', '2019-01-03 19:19:48', '2019-01-29 21:36:41'),
('JK_0004', 'KD_0002', 5, '15:20:00', '22:00:00', 'TG_0001', 'Test', '2019-06-14 12:32:11', '0000-00-00 00:00:00'),
('JK_0005', 'KD_0001', 0, '17:00:00', '23:55:00', 'TG_0002', '', '2019-06-16 11:48:10', '0000-00-00 00:00:00'),
('JK_0006', 'KD_0001', 0, '00:05:00', '12:20:00', 'TG_0001', '', '2019-07-02 13:34:19', '0000-00-00 00:00:00'),
('JK_0007', 'KD_0001', 2, '01:25:00', '12:20:00', 'TG_0001', '', '2019-07-02 13:34:49', '0000-00-00 00:00:00');
...
('KD_0001', 'kandang ayam 1', 'KR_0002', '2019-06-18 13:46:33', '2019-01-29 20:56:55'),
('KD_0002', 'kandang ayam 2', 'KR_0001', '2019-06-18 13:46:40', '2019-05-27 16:26:43'),
('KD_0003', 'kandang ayam 3', 'KR_0002', '2019-06-18 13:46:47', '2019-05-27 16:26:43'),
('KD_0004', 'kandang ayam 4', 'KR_0001', '2019-06-18 13:46:53', '2019-05-27 16:26:43');
...
('SP_0001', 'Potong ayam kartini', 'Jl. Kusuma Negara no.5', '+62855470001', 'Y'),
('SP_0004', 'Potong ayam makmur', 'Jl. Kawitan no. 6 Sidorejo', '08547132566', 'Y'),
('SP_0005', 'Potong ayam sugih', 'asdfasd', '34234', 'Y'),
('SP_0006', 'Potong ayam bantul', 'hahahihi', 'kuyfdqtu8467845', 'Y');
...
--
DROP VIEW IF EXISTS `tb_view_stok_gudang`;
...
--
DROP VIEW IF EXISTS `view_dashboard_kerugian_ayam`;
...
--
DROP VIEW IF EXISTS `view_dashboard_pembelian_ayam`;
...
--
DROP VIEW IF EXISTS `view_dashboard_penjualan_ayam`;
...
--
DROP VIEW IF EXISTS `view_history_transaksi`;
...
--
DROP VIEW IF EXISTS `view_history_transaksi_gudang`;
...
--
DROP VIEW IF EXISTS `view_jadwal_penggunaan_gudang`;
...
--
DROP VIEW IF EXISTS `view_kandang_avaliable`;
...
--
DROP VIEW IF EXISTS `view_periode_transaksi`;
...
--
DROP VIEW IF EXISTS `view_sisa_pembelian`;
...
--
DROP VIEW IF EXISTS `view_stok_ayam`;
...
--
DROP VIEW IF EXISTS `view_stok_gudang`;
...
--
DROP VIEW IF EXISTS `view_transaksi_ayam`;
...
--
DROP VIEW IF EXISTS `view_transaksi_gudang`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`user`@`localhost` SQL SECURITY DEFINER VIEW `view_kandang_avaliable` AS select `tb_kandang`.`id_kandang` AS `id_kandang`,`tb_kandang`.`nama` AS `nama`,`tb_kandang`.`id_karyawan` AS `id_karyawan`,`tb_kandang`.`created_at` AS `created_at`,`tb_kandang`.`updated_at` AS `updated_at` from `tb_kandang` where `tb_kandang`.`id_kandang` in (select `view_sisa_pembelian`.`id_kandang` from `view_sisa_pembelian` where (`view_sisa_pembelian`.`jumlah_sisa_ayam` > 0));
