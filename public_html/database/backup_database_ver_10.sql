...
begin 
	...
	declare perbandingan_umur int;
    
    declare tanggal_umur date;
    declare tanggal_tmp date;
    
    set tanggal_tmp = "2019-01-30 00:00:00";
    set id_pembelian_ayam_temp = "MA_0017";
    
	select @umur := tb_detail_pembelian_ayam.umur,
    	@tanggal_beli := tb_detail_pembelian_ayam.tanggal
    	from tb_detail_pembelian_ayam 
    	WHERE id_detail_pembelian_ayam = id_pembelian_ayam_temp limit 1;
        
    set perbandingan_umur = datediff(tanggal_tmp, @tanggal_beli);
    
    if perbandingan_umur > 60 THEN
    	select "simpan data";
    end if;
end$$
...
INSERT INTO `tb_detail_pembelian_ayam` (`id_detail_pembelian_ayam`, `id_kandang`, `id_supplier`, `id_karyawan`, `id_admin`, `tanggal`, `umur`, `jumlah_ayam`, `update_by_admin`, `update_by_karyawan`, `created_at`, `updated_at`) VALUES
('MA_0017', 'KD_0001', 'SP_0001', NULL, 5, '2018-11-12 00:00:00', 30, 10, NULL, NULL, '2019-05-28 07:22:05', '2019-01-29 17:39:29'),
('MA_0019', 'KD_0001', 'SP_0001', NULL, 5, '2018-11-12 00:00:00', 30, 120, NULL, NULL, '2019-05-28 07:22:09', '2019-05-27 16:26:43'),
('MA_0020', 'KD_0001', 'SP_0001', 'KR_0002', NULL, '2018-11-12 00:00:00', 30, 120, 5, NULL, '2019-05-28 07:22:15', '2019-01-01 13:38:55'),
('MA_0021', 'KD_0003', 'SP_0001', NULL, 5, '2018-11-12 00:00:00', 30, 100, NULL, NULL, '2019-05-28 07:22:19', '2019-05-27 16:26:43'),
('MA_0022', 'KD_0001', 'SP_0005', NULL, 5, '2019-01-30 00:00:00', 30, 2, 5, NULL, '2019-05-28 07:22:21', '2019-01-29 21:10:18'),
('MA_0023', 'KD_0001', 'SP_0006', NULL, 5, '2019-01-30 00:00:00', 30, 100, NULL, NULL, '2019-05-28 07:22:24', '2019-05-27 16:26:43');
...
('TG_0002', 'Pakan Katul', '', 3, '2019-05-28 13:23:35', '2019-01-06 15:46:47'),
('TG_0003', 'Vaksin ', '', 2, '2019-05-28 13:23:41', '2019-01-29 21:29:20');
