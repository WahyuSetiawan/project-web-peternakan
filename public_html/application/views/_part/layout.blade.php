...
<head>
    ...
    <link href="<?php echo base_url('asset/') ?>vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet"
        media="all">
    <link href="<?php echo base_url('asset/') ?>vendor/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet"
        media="all">
    <link href="<?php echo base_url('asset/') ?>vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet"
        media="all">
    ...
    <!-- Vendor CSS-->
    <link href="<?php echo base_url('asset/') ?>vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
        media="all">
...
<body class="animsition">
    <div class="page-wrapper">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo base_url('asset/') ?>images/1486395884-account_80606.png"
                                                alt="<?php echo ($username->username) ?>" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">
                                                <?php echo ($username->username) ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?= base_url('asset/') ?>images/1486395884-account_80606.png"
                                                            alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
        ...
        <!-- modal medium -->
        <div class="modal fade" id="modelChangePassword" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
            aria-hidden="true">
    ...
    <script src="<?php echo base_url(" js/bootstrap-datetimepicker.min.js") ?>
        " type="
        text / javascript ">
    </script>
    * */ ?>
    ...
    <script>
        $(document).ready(function () {
            var a = "nav.navbar-sidebar li.has-sub a[href='" + $("meta[name='base_url_controller']").attr(
                'content').replace("index.php/", '') + "']";

            $(a).parent("li").addClass("active")
                .parents("li.has-sub").addClass("active")
                .find('a.js-arrow').trigger("click");
            $("nav.navbar-sidebar a[href='" + $("meta[name='base_url_controller']").attr('content').replace(
                "index.php/", '') + "']").parent("li").addClass("active");
        });
    </script>
