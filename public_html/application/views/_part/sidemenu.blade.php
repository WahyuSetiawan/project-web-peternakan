...
<div class="menu">
    ...
    <div class="submenu">
        <a href="{{base_url('kandang')}}"> <i class="fa fa-caret-down"></i> Kandang</a>
        <a href="{{base_url('supplier')}}"><i class="fa fa-address-book"></i> Supplier</a>
        <a href="{{base_url('persediaan')}}"><i class="fa fa-address-book"></i> Persediaan</a>
        <a href="{{base_url('jadwalpersediaan')}}"><i class="fa fa-address-book"></i> Jadwal Persediaan</a>
        <a href="{{base_url('karyawan')}}"><i class="fa fa-address-book"></i> Karyawan</a>
    </div>
</div>
<div class="menu">
    <div class="title">
    ...
    <div class="submenu">
        <a href="{{base_url('kandang/pembelian')}}">Pembelian Ayam</a>
        <a href="{{base_url('kandang/penjualan')}}">Penjualan Ayam</a>
        <a href="{{base_url('persediaan/pembelian')}}">Pembelian Persediaan</a>
        <a href="{{base_url('persediaan/penjualan')}}">Pengunaan Persediaan</a>
