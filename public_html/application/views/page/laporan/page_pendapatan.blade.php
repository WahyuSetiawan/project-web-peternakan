                    ...
                    <?php foreach ($data as $key => $value) { ?>
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a type="button" class="btn btn-success" href="<?php echo base_url($_SERVER["REQUEST_URI"]) . (($_SERVER["QUERY_STRING"] != "") ? "&" : "?") . "type=html&id=" . $value->id_detail_pembelian_ayam ?>">Cetak Pendapatan</a>
                            </td>
                        </tr>
                    <?php } ?>
