        ...
        <form action="" method="post" id="form-kandang">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <select class="form-control" name="jadwal">
                                <?php foreach ($jadwal as $key => $value) { ?>
                                    <option value="<?php echo $value->id_jadwal_kandang ?>" data-jadwal='<?= json_encode($value) ?>''>
                                            <?php echo $value->id_jadwal_kandang . " " . $value->nama_kandang . " " . $value->nama_gudang . " " . $value->waktu_mulai . " " . $value->waktu_selesai ?>
                                        </option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label>Persediaan yang digunakan</label>
