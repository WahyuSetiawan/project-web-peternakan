        ...
        <form action="" method="post" id="form-kandang">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="mediumModalLabel">Tambah Pembelian Persediaan</h3>
...
<script>
    ...
    modal.find("form").find("select[name='persediaan']").on("click", function () {
        changeSupplier();
    });

    function changeSupplier() {
        var select = modal.find("form").find("select[name='persediaan']");
