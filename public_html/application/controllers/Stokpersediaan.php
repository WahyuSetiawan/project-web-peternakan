...
class Stokpersediaan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['count'] = $this->ViewModel->countViewStokPersediaan($params);
        ...
        $this->data['data'] = $this->ViewModel->getViewStokPersediaan(
            $this->data['limit'], $this->data['offset']);

        $this->blade->view("page.stok.persediaan.stok", $this->data);
    }
    ...
    public function detail($id_persediaan = false)
    {
        ...
        $this->data['offset'] = ($page > 0) ? (($page - 1) * $per_page) : $page;
        $this->data['limit'] = $per_page;
        $this->data['count'] = $this->ViewModel->countViewTransaksiPersediaan($id_persediaan, $params);
        ...
        if ($id_persediaan) {
            $this->data['data'] = $this->ViewModel->getViewTransaksiPersediaan(
                $this->data['limit'], 
                $this->data['offset'], 
                $id_persediaan, 
                $params
