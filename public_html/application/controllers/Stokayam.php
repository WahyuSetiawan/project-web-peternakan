...
class Stokayam extends MY_Controller {
    ...
    public function detail($id_kandang = false, $page = false) {
        $this->data['jumlah'] = $this->ViewModel->viewCountTransaksiKandang($id_kandang);
        
        if ($id_kandang) {
            $this->data['data'] = $this->ViewModel->viewTransaksiKandang(null, null, $id_kandang);
            
            $this->blade->view("page.kandang.detail_transaksi", $this->data);
        }
    }
