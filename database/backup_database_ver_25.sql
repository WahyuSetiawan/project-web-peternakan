...
--
-- Host: localhost
-- Generation Time: Jul 26, 2019 at 07:54 PM
...
('KA_0001', NULL, 'KD_0001', 'GT_0003', '2019-07-25 00:00:00', '', 20, NULL, 'KR_0001', NULL, NULL, '2019-07-25 16:21:48', '0000-00-00 00:00:00'),
('KA_0002', NULL, 'KD_0001', 'GT_0005', '2019-07-26 00:00:00', '', 30, NULL, 'KR_0001', NULL, NULL, '2019-07-25 17:21:49', '0000-00-00 00:00:00');
...
('MA_0001', 'KD_0001', 'SP_0002', 'KR_0001', NULL, 'GT_0003', '2019-07-25 00:00:00', 0, 100, 10000, NULL, NULL, '2019-07-25 18:40:53', '0000-00-00 00:00:00'),
('MA_0002', 'KD_0001', 'SP_0003', 'KR_0001', NULL, 'GT_0003', '2019-07-25 00:00:00', 1, 70, 10000, NULL, NULL, '2019-07-25 18:40:57', '0000-00-00 00:00:00'),
('MA_0003', 'KD_0002', 'SP_0001', 'KR_0001', NULL, 'GT_0004', '2019-07-25 00:00:00', 130, 100, 100000, NULL, NULL, '2019-07-25 16:52:42', '0000-00-00 00:00:00'),
('MA_0004', 'KD_0001', 'SP_0003', 'KR_0001', NULL, 'GT_0005', '2019-07-26 00:00:00', 2, 30, 100800, NULL, NULL, '2019-07-25 18:41:01', '0000-00-00 00:00:00'),
('MA_0005', 'KD_0001', 'SP_0001', 'KR_0001', NULL, 'GT_0005', '2019-07-26 00:00:00', 121, 50, 10000, NULL, NULL, '2019-07-25 17:19:38', '0000-00-00 00:00:00'),
('MA_0006', 'KD_0001', 'SP_0001', 'KR_0001', NULL, 'GT_0005', '2019-07-27 00:00:00', 3, 30, 0, NULL, NULL, '2019-07-26 17:57:52', '0000-00-00 00:00:00');
...
('KA_0001', 'KD_0001', 'KR_0001', NULL, 'GT_0003', '2019-07-25 00:00:00', 50, 150000, '', NULL, NULL, '2019-07-25 16:21:16', '0000-00-00 00:00:00'),
('KA_0002', 'KD_0001', 'KR_0001', NULL, 'GT_0003', '2019-07-25 00:00:00', 30, 110000, '', NULL, NULL, '2019-07-25 16:21:34', '0000-00-00 00:00:00'),
('KA_0003', 'KD_0001', 'KR_0001', NULL, 'GT_0005', '2019-07-26 00:00:00', 30, 30000, '', NULL, NULL, '2019-07-25 17:19:57', '0000-00-00 00:00:00'),
('KA_0004', 'KD_0001', 'KR_0001', NULL, 'GT_0005', '2019-07-26 00:00:00', 40, 40000, '', NULL, NULL, '2019-07-25 17:20:10', '0000-00-00 00:00:00'),
('KA_0005', 'KD_0002', 'KR_0001', NULL, 'GT_0004', '2019-07-27 00:00:00', 50, 10000, '', NULL, NULL, '2019-07-26 18:02:16', '0000-00-00 00:00:00');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`user`@`%` SQL SECURITY DEFINER VIEW `view_detail_group_transaksi` AS select `tb_detail_group_transaksi`.`id_detail_group_transaksi` AS `id_detail_group_transaksi`,`tb_detail_group_transaksi`.`created_at` AS `created_at`,`tb_detail_group_transaksi`.`updated_at` AS `updated_at`,(select distinct `tb_detail_pembelian_ayam`.`id_kandang` from `tb_detail_pembelian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_pembelian_ayam`.`id_detail_group_transaksi`) limit 1) AS `id_kandang`,(select `tb_kandang`.`nama` from `tb_kandang` where (`tb_kandang`.`id_kandang` = (select distinct `tb_detail_pembelian_ayam`.`id_kandang` from `tb_detail_pembelian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_pembelian_ayam`.`id_detail_group_transaksi`) limit 1))) AS `nama_kandang`,(select count(0) from `tb_detail_pembelian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_pembelian_ayam`.`id_detail_group_transaksi`) limit 1) AS `jumlah_pembelian`,(select count(0) from `tb_detail_penjualan_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_penjualan_ayam`.`id_detail_group_transaksi`) limit 1) AS `jumlah_penjualan`,(select count(0) from `tb_detail_kerugian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_kerugian_ayam`.`id_detail_group_transaksi`) limit 1) AS `jumlah_kerugian`,(select sum(`tb_detail_pembelian_ayam`.`harga_ayam`) from `tb_detail_pembelian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_pembelian_ayam`.`id_detail_group_transaksi`)) AS `pembelian`,(select sum(`tb_detail_pembelian_ayam`.`jumlah_ayam`) from `tb_detail_pembelian_ayam` where (`tb_detail_group_transaksi`.`id_detail_group_transaksi` = `tb_detail_pembelian_ayam`.`id_detail_group_transaksi`)) AS `jumlah_ayam_pembelian`,(select sum(`tb_detail_penjualan_ayam`.`harga`) from `tb_detail_penjualan_ayam` where (`tb_detail_penjualan_ayam`.`id_detail_group_transaksi` = `tb_detail_penjualan_ayam`.`id_detail_group_transaksi`)) AS `penjualan`,(select sum(`tb_detail_penjualan_ayam`.`jumlah_ayam`) from `tb_detail_penjualan_ayam` where (`tb_detail_penjualan_ayam`.`id_detail_group_transaksi` = `tb_detail_penjualan_ayam`.`id_detail_group_transaksi`)) AS `jumlah_ayam_penjualan`,(select sum(`tb_detail_kerugian_ayam`.`jumlah`) from `tb_detail_kerugian_ayam` where (`tb_detail_kerugian_ayam`.`id_detail_group_transaksi` = `tb_detail_kerugian_ayam`.`id_detail_group_transaksi`)) AS `jumlah_ayam_kerugian` from `tb_detail_group_transaksi`;
