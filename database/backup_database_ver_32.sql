...
--
-- Host: localhost
-- Generation Time: Aug 15, 2019 at 04:56 PM
...
CREATE  FUNCTION `function_id_group_transaksi`() RETURNS varchar(10) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
begin
	...
	select count(*) into count_id from tb_karyawan;
	
	IF count_id = 0 then
		set id = 1;
	else
		select substring(max(id_karyawan), 5) + 1 into id from tb_karyawan;
	end if;
...
('KA_0001', NULL, 'KD_0001', 'GT_0007', '2019-08-04 00:00:00', 'mati', 10, NULL, 'KR_0001', NULL, NULL, '2019-08-04 10:59:47', '0000-00-00 00:00:00');
...
('MA_0002', 'KD_0001', 'SP_0001', 'KR_0001', NULL, 'GT_0007', '2019-08-02 00:00:00', 140, 50, 10000, NULL, NULL, '2019-08-04 08:43:06', '0000-00-00 00:00:00'),
('MA_0003', 'KD_0002', 'SP_0001', 'KR_0001', NULL, 'GT_0009', '2019-08-04 00:00:00', 10, 100, 10000, NULL, NULL, '2019-08-04 12:30:14', '0000-00-00 00:00:00'),
('MA_0004', 'KD_0002', 'SP_0001', 'KR_0001', NULL, 'GT_0009', '2019-08-04 00:00:00', 14, 10, 0, NULL, NULL, '2019-08-04 12:42:25', '0000-00-00 00:00:00');
...
INSERT INTO `tb_detail_penjualan_ayam` (`id_detail_penjualan_ayam`, `id_kandang`, `id_karyawan`, `id_admin`, `id_detail_group_transaksi`, `tanggal`, `jumlah_ayam`, `harga`, `keterangan`, `update_by_karyawan`, `update_by_admin`, `created_at`, `updated_at`) VALUES
('KA_0001', 'KD_0001', 'KR_0001', NULL, 'GT_0007', '2019-08-04 00:00:00', 10, 10, '', NULL, NULL, '2019-08-04 09:27:26', '0000-00-00 00:00:00'),
('KA_0002', 'KD_0001', 'KR_0001', NULL, 'GT_0007', '2019-08-04 00:00:00', 10, 10, '', NULL, NULL, '2019-08-04 10:19:27', '0000-00-00 00:00:00');
...
('KR_0004', 'asdf', 'asdf', 'asdf', 'e10adc3949ba59abbe56e057f20f883e', '123456', '2019-08-14 15:56:08', '0000-00-00 00:00:00');
