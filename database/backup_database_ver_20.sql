...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jul 2019 pada 16.44
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
-- Prosedur
--
CREATE  PROCEDURE `pd_insert_detail_penggunaan_gudang`()
    READS SQL DATA
begin 
...
CREATE  PROCEDURE `pd_insert_detail_penjualan_ayam`()
    NO SQL
begin 
	declare umur int;
...
CREATE  PROCEDURE `pd_select_detail_pembelian_ayam`()
    NO SQL
select *, 
...
CREATE  PROCEDURE `pd_show_jadwal_penggunaan`(IN `dateTmp` DATETIME, IN `kandangTmp` VARCHAR(7), IN `gudangTmp` VARCHAR(7))
    NO SQL
select 
	* 
from 
...
-- Fungsi
--
CREATE  FUNCTION `function_detail_type_supplier`() RETURNS varchar(8) CHARSET latin1
begin
	declare id INT;
...
CREATE  FUNCTION `function_id_detail_kandang_persediaan`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_kerugian_ayam`() RETURNS varchar(7) CHARSET utf8mb4
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_pembelian_ayam`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_pembelian_gudang`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_pengeluaran_gudang`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_penjualan_ayam`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_detail_persediaan`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_gudang`() RETURNS varchar(10) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_jadwal_kandang`() RETURNS varchar(7) CHARSET utf8mb4
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_kandang`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_karyawan`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_supplier`() RETURNS varchar(7) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_id_type_gudang`() RETURNS varchar(10) CHARSET latin1
begin
	declare id INT;
	declare count_id INT;
	declare code varchar(11);
...
CREATE  FUNCTION `function_status_pemberian_pakan`(`id_gudang_in_temp` VARCHAR(7), `id_kandang_in_tmp` VARCHAR(7), `tanggal_tmp` DATETIME) RETURNS tinyint(1)
    NO SQL
begin 
    declare count_data_exists int;
    declare durasi_gudang int;
...
CREATE  FUNCTION `function_status_pemberian_pakan_edit`(`id_gudang_in_temp` VARCHAR(7), `id_kandang_in_tmp` VARCHAR(7), `tanggal_tmp` DATETIME, `id_detail_edit` VARCHAR(7)) RETURNS varchar(7) CHARSET latin1
    NO SQL
begin 
    declare count_data_exists int;
    declare durasi_gudang int;
...
CREATE  FUNCTION `function_status_penjualan_ayam`(`id_pembelian_ayam_temp` VARCHAR(7), `tanggal_tmp` DATE) RETURNS int(11)
    NO SQL
begin 
	declare umur int;
...
--
-- Struktur dari tabel `detail_kandang_persediaan`
--
...
--
-- Dumping data untuk tabel `detail_kandang_persediaan`
--
...
--
-- Struktur dari tabel `detail_persediaan`
--
...
--
-- Dumping data untuk tabel `detail_persediaan`
--
...
--
-- Struktur dari tabel `detail_supplier_jenis`
--
...
--
-- Dumping data untuk tabel `detail_supplier_jenis`
--
...
--
-- Struktur dari tabel `detail_type_supplier`
--
...
--
-- Dumping data untuk tabel `detail_type_supplier`
--
...
--
-- Struktur dari tabel `kandang_persediaan_history`
--
...
--
-- Dumping data untuk tabel `kandang_persediaan_history`
--
...
--
-- Struktur dari tabel `tb_detail_kerugian_ayam`
--
...
--
-- Dumping data untuk tabel `tb_detail_kerugian_ayam`
--
...
--
-- Struktur dari tabel `tb_detail_pembelian_ayam`
--
...
--
-- Dumping data untuk tabel `tb_detail_pembelian_ayam`
--
...
--
-- Struktur dari tabel `tb_detail_pembelian_gudang`
--
...
--
-- Dumping data untuk tabel `tb_detail_pembelian_gudang`
--
...
--
-- Struktur dari tabel `tb_detail_penggunaan_gudang`
--
...
--
-- Dumping data untuk tabel `tb_detail_penggunaan_gudang`
--
...
--
-- Struktur dari tabel `tb_detail_penjualan_ayam`
--
...
--
-- Dumping data untuk tabel `tb_detail_penjualan_ayam`
--

INSERT INTO `tb_detail_penjualan_ayam` (`id_detail_penjualan_ayam`, `id_detail_pembelian_ayam`, `id_kandang`, `id_karyawan`, `id_admin`, `tanggal`, `jumlah_ayam`, `harga`, `keterangan`, `update_by_karyawan`, `update_by_admin`, `created_at`, `updated_at`) VALUES
('KA_0001', 'MA_0017', NULL, 'KR_0002', NULL, '2018-11-12 00:00:00', 48, 100000, 'asdf', NULL, 5, '2019-07-15 18:05:53', '2019-01-01 14:58:18'),
('KA_0002', 'MA_0017', NULL, 'KR_0002', NULL, '2018-12-12 00:00:00', 50, 100000, 'asdf', NULL, NULL, '2019-07-15 18:06:01', '2019-05-27 16:26:43'),
('KA_0004', 'MA_0017', NULL, NULL, 5, '2019-01-30 00:00:00', 2, 100000, 'gfjdgngmfgm', NULL, NULL, '2019-07-15 18:06:05', '2019-05-27 16:26:43'),
('KA_0006', 'MA_0019', NULL, 'KR_0001', NULL, '2019-06-05 00:00:00', 11, 0, 'jual', NULL, NULL, '2019-06-05 23:31:22', '0000-00-00 00:00:00'),
('KA_0007', 'MA_0022', NULL, 'KR_0001', NULL, '2019-06-18 00:00:00', 2, 20000, '', NULL, NULL, '2019-06-18 13:44:49', '0000-00-00 00:00:00'),
('KA_0008', 'MA_0021', NULL, 'KR_0001', NULL, '2019-07-02 00:00:00', 10, 100000, '', NULL, NULL, '2019-07-02 17:25:48', '0000-00-00 00:00:00'),
('KA_0009', 'MA_0021', NULL, 'KR_0001', NULL, '2019-07-15 00:00:00', 20, 90000, 'kjggjkgjkgk', NULL, NULL, '2019-07-15 15:20:49', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_detail_supplier_jenis`
--
...
--
-- Dumping data untuk tabel `tb_detail_supplier_jenis`
--
...
--
-- Struktur dari tabel `tb_detail_type_supplier`
--
...
--
-- Dumping data untuk tabel `tb_detail_type_supplier`
--
...
--
-- Struktur dari tabel `tb_jadwal_kandang`
--
...
--
-- Dumping data untuk tabel `tb_jadwal_kandang`
--
...
ALTER TABLE `detail_type_supplier`
 ADD PRIMARY KEY (`id_detail_type_supplier`), ADD KEY `FK_detail_type_supplier_supplier` (`id_supplier`), ADD KEY `FK_detail_type_supplier_type_supplier` (`id_gudang`);
...
ALTER TABLE `tb_detail_kerugian_ayam`
 ADD PRIMARY KEY (`id_detail_kerugian_ayam`), ADD KEY `FK_tb_detail_kerugian_ayam_tb_admin` (`id_admin`), ADD KEY `FK_tb_detail_kerugian_ayam_tb_karyawan` (`id_karyawan`), ADD KEY `FK_tb_detail_kerugian_ayam_tb_admin_2` (`update_by_admin`), ADD KEY `FK_tb_detail_kerugian_ayam_tb_karyawan_2` (`update_by_karyawan`), ADD KEY `id_detail_pembelian_ayam` (`id_detail_pembelian_ayam`);

--
-- Indexes for table `tb_detail_pembelian_ayam`
--
ALTER TABLE `tb_detail_pembelian_ayam`
 ADD PRIMARY KEY (`id_detail_pembelian_ayam`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_kandang` (`id_kandang`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_admin` (`id_admin`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_karyawan` (`id_karyawan`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_supplier` (`id_supplier`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_admin_2` (`update_by_admin`), ADD KEY `FK_tb_detail_pembelian_ayam_tb_karyawan_2` (`update_by_karyawan`);

--
-- Indexes for table `tb_detail_pembelian_gudang`
--
ALTER TABLE `tb_detail_pembelian_gudang`
 ADD PRIMARY KEY (`id_detail_pembelian_gudang`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_supplier` (`id_supplier`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_gudang` (`id_gudang`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_admin` (`id_admin`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_karyawan` (`id_karyawan`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_karyawan_2` (`update_by_karyawan`), ADD KEY `FK_tb_detail_pembelian_gudang_tb_admin_2` (`update_by_admin`);

--
-- Indexes for table `tb_detail_penggunaan_gudang`
--
ALTER TABLE `tb_detail_penggunaan_gudang`
 ADD PRIMARY KEY (`id_detail_penggunaan_gudang`), ADD KEY `FK_tb_detail_penggunaan_gudang_tb_gudang` (`id_gudang`), ADD KEY `FK_tb_detail_penggunaan_gudang_tb_karyawan` (`id_karyawan`), ADD KEY `FK_tb_detail_penggunaan_gudang_tb_admin` (`id_admin`), ADD KEY `FK_tb_detail_penggunaan_gudang_tb_karyawan_2` (`update_by_karyawan`), ADD KEY `FK_tb_detail_penggunaan_gudang_tb_admin_2` (`update_by_admin`);

--
-- Indexes for table `tb_detail_penjualan_ayam`
--
ALTER TABLE `tb_detail_penjualan_ayam`
 ADD PRIMARY KEY (`id_detail_penjualan_ayam`), ADD KEY `FK_tb_detail_penjualan_ayam_tb_kandang` (`id_kandang`), ADD KEY `FK_tb_detail_penjualan_ayam_tb_karyawan` (`id_karyawan`), ADD KEY `FK_tb_detail_penjualan_ayam_tb_admin` (`id_admin`), ADD KEY `FK_tb_detail_penjualan_ayam_tb_karyawan_2` (`update_by_karyawan`), ADD KEY `FK_tb_detail_penjualan_ayam_tb_admin_2` (`update_by_admin`), ADD KEY `FK_id_detail_pembelian_ayam_tb_pembelian_ayam` (`id_detail_pembelian_ayam`);

--
-- Indexes for table `tb_detail_supplier_jenis`
--
ALTER TABLE `tb_detail_supplier_jenis`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id_supplier_id_jenis` (`id_supplier`,`id_gudang`), ADD KEY `FK_detail_supplier_jenis_type_gudang` (`id_gudang`);

--
-- Indexes for table `tb_detail_type_supplier`
--
ALTER TABLE `tb_detail_type_supplier`
 ADD PRIMARY KEY (`id_detail_type_supplier`), ADD KEY `FK_tb_detail_type_supplier_tb_gudang` (`id_gudang`), ADD KEY `FK_tb_detail_type_supplier_tb_supplier` (`id_supplier`);
...
ALTER TABLE `tb_jadwal_kandang`
 ADD PRIMARY KEY (`id_jadwal_kandang`), ADD KEY `id_kandang` (`id_kandang`), ADD KEY `id_persediaan` (`id_gudang`);

--
-- Indexes for table `tb_kandang`
--
ALTER TABLE `tb_kandang`
 ADD PRIMARY KEY (`id_kandang`), ADD KEY `FK_tb_kandang_tb_karyawan` (`id_karyawan`);
...
--
-- Ketidakleluasaan untuk tabel `tb_detail_kerugian_ayam`
--
ALTER TABLE `tb_detail_kerugian_ayam`
...
--
-- Ketidakleluasaan untuk tabel `tb_detail_penjualan_ayam`
--
ALTER TABLE `tb_detail_penjualan_ayam`
