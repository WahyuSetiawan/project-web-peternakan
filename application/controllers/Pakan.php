...
class Pakan extends MY_Controller
{
    ...
    public function belum()
    {
        ...
        if (null !== ($this->input->post("submit"))) {
            ...
            $data_jadwal = $this->jadwalKandangModel->get(false, false, $this->input->post("id_jadwal"));

            $jumlah_stok = $this->detailPenggunaanGudangModel->stokGudang($data_jadwal[0]->id_gudang);

            $this->form_validation->set_rules(
                "jumlah",
                'Jumlah',
                'required|less_than_equal_to[' . $jumlah_stok . ']',
                [
                    'less_than_equal_to' => 'Peringatan, stok melebihi stok gudang yang ada',
