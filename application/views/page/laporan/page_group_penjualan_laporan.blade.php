...
?>
    ...
    <div class="table-data__tool-right">
        <button class="btn btn-success" href="<?=base_url("laporan/group/penjualan/" . $id_group . "/html" )?>">
...
@section(' js') <script>
                                    ...
                                    if (parseInt(value) <=
                                        ...
                                        $("#form-penjualan").validate({ rules: { nama: { required: true, minlength: 1 },
                                        jumlah: { required: true, number: true, min: 1, maksimalStok: { } }, harga: {
                                        required: true, number: true, min: 1, } }, messages: { nama: {
                                        required: "Nama tidak boleh kosong" , minlength: "Minimal karakter adalah 1" },
                                        jumlah: { required: "Jumlah tidak boleh kosong" , number: "Harus Berupa Angka" ,
                                        min: "Minimal jumlah yang dinputkan adalah 1" ,
                                        max: "Jumlah ayam penjualan melebihi stok ayan" }, harga: {
                                        required: "Harga tidak boleh kosong" , number: "Harga harus berupa angka" ,
                                        min: "Harga tidak boleh dibawah angak 0" } }, errorElement: "em" ,
