...
<div class="column">
    <h3 class="title-5 m-b-25">Jadwal Pakan yang belum di berikan (Tanggal :
        <?php echo (isset($current_date_view_target)) ? $current_date_view_target : $current_date_view ?> )</h3>
    ...
    <div class="col-2 m-b-25">
        <div class="row">
            ...
            <div class="row">
                <div class="col-4">
                    <label class="center">Waktu Sekarang :
                        <?= (isset($current_time_view)) ? $current_time_view : '' ?></label>
                </div>
            </div>
        </div>
    </div>
            ...
            <tr>
                ...
                <td class="aksi">
                    <?php
                        ...
                        if(isset($current_date_target)){
                            $date01 = DateTime::createFromFormat('Y-m-d', $current_date_target);
                            $date11 = DateTime::createFromFormat('Y-m-d', $current_date_view);

                            if ($date01 < $date11) {
                                echo '<div style="color: red">Waktu telah lewat !!!</div>';
                            }

                            if ($date1 > $date2 && $date1 < $date3 && $date01 == $date11) { ?>
                    <button type="button" class="btn btn-primary edit-jadwal"
                        data-jadwal='<?= json_encode($value) ?>'>Masukan data</button>
                    <?php }
                        ...
                        if ($date1 < $date2) {
                            echo '<div style="color: blue">Waktu belum tiba</div>';
                        }
                        ?>
                </td>
            </tr>
...
<!-- modal medium -->
<div class="modal fade" id="modal-jadwal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tanggal" value="<?= $current_date_view ?>"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="waktu" value="<?= $current_time_view ?>"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label>Jumlah pakan yang diberikan ( Maksimal : <span class="jumlah_maksimal"></span> )</label>
...
<script>
    ...
    $(document).on("click", ".btn-add-jadwal", function() {
        ...
        modal.find('form').find("input[name='jadwal']").val("");
        modal.find('form').find("input[name='id_jadwal']").val("");
    ...
    $(document).on("click", ".edit-jadwal", function() {
        ...
        modal.find('form').find("input[name='id_jadwal']").val(data.id_jadwal_kandang);
        ...
        modal.find("form").find("input[name=jumlah]").attr("placeholder", data.jumlah_gudang);
        modal.find("form").find("input[name=jumlah_maksimal]").val(data.jumlah_gudang);
        modal.find("form").find("span.jumlah_maksimal").html(data.jumlah_gudang);
