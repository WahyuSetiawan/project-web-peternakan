            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <button type="button" class="btn btn-primary edit-kandang"
                            data-supplier='<?=json_encode($value)?>'><i class="fa fa-edit"></i></button>
                        <button type="button" class="btn btn-danger del-kandang"
...
<!-- modal medium -->
<div class="modal fade" id="modalKandang" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
    aria-hidden="true">
    ...
    $("#form-kandang").validate({
        ...
        messages: {
            ...
            stok: {
                ...
                min: "Jumlah minimal untuk stok ayam adalah 10"
            },
            karyawan: {
