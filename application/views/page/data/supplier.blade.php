            ...
            <table class="table table-borderless table-striped table-earning">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                            foreach ($value->jenis as $key_a => $value_jenis) {
                                if($key_a > 0){
                                    echo ", ";
                                }

                                echo $value_jenis->nama;
                            }
                            ?>
                        </td>
                        <td style="text-align: center">
                            <button type="button" class="btn btn-primary edit-supplier"
                                data-supplier='<?= json_encode($value) ?>'><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn btn-danger del-supplier"
                                data-supplier='<?= json_encode($value) ?>'><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php } ?>
...
<!-- modal medium -->
<div class="modal fade" id="modalSupplier" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label>Kota</label>
                            <input type="text" class="form-control" name="kota" placeholder="Kota supplier">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="ayam" id=""
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input lass="form-check-input" type="checkbox" name="jenis_supplier[]"
                                value="<?= $value->id_gudang ?>">
                            <?= $value->nama ?> <br>
                            <?php } ?>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on("click", ".edit-supplier", function () {
        ...
        modalSupplier.find("input[name='email']").val(data.email);
