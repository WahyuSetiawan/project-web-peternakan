    ...
    <div class="container">
        <div class="top-nav">
            ...
            <div class="pull-right drop-menu">
                <div class="button js-open-menu" style="text-transform: capitalize; cursor: default">{{$head['type']}}
                </div>
                ...
                <div class="nav-menu">
                    ...
                    <div class="footer">
                        <input type="button" class="btn btn-info change-password" value="Change Password"
                            data-user="{{json_encode($head['username'])}}">
